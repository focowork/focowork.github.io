...
function saveUserName() {
  const value = document.getElementById('inputUserName').value.trim();
  if (!value) {
    showAlert('Nombre requerido', 'Debes introducir tu nombre para continuar', '⚠️');
    return;
  }
  userName = value;
  localStorage.setItem('focowork_user_name', value);
  closeModal('modalUserName');
  updateUI();
}
/* =============== FIN USER OBLIGATORIO =============== */
